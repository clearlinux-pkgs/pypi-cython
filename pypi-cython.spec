...
Source0  : https://files.pythonhosted.org/packages/0e/17/c5b026cea7a634ee3b8950a7be16aaa49deeb3b9824ba5e81c13ac26f3c4/Cython-3.0.9.tar.gz
...
%prep
%setup -q -n Cython-3.0.9
cd %{_builddir}/Cython-3.0.9
pushd ..
cp -a Cython-3.0.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709739097

...
Source0  : https://files.pythonhosted.org/packages/5a/25/886e197c97a4b8e254173002cdc141441e878ff29aaa7d9ba560cd6e4866/cython-3.0.12.tar.gz
...
%prep
%setup -q -n cython-3.0.12
cd %{_builddir}/cython-3.0.12
pushd ..
cp -a cython-3.0.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739286281

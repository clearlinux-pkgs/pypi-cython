...
Source0  : https://files.pythonhosted.org/packages/cb/da/54a5d7a7d9afc90036d21f4b58229058270cc14b4c81a86d9b2c77fd072e/Cython-0.29.28.tar.gz
...
%prep
%setup -q -n Cython-0.29.28
cd %{_builddir}/Cython-0.29.28
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649733837
...
cp %{_builddir}/Cython-0.29.28/COPYING.txt %{buildroot}/usr/share/package-licenses/pypi-cython/38099d4531dd3d32b72df546041f15201123547f
cp %{_builddir}/Cython-0.29.28/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-cython/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33

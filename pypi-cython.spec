...
Source0  : https://files.pythonhosted.org/packages/d5/f7/2fdd9205a2eedee7d9b0abbf15944a1151eb943001dbdc5233b1d1cfc34e/Cython-3.0.10.tar.gz
...
%prep
%setup -q -n Cython-3.0.10
cd %{_builddir}/Cython-3.0.10
pushd ..
cp -a Cython-3.0.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711839968

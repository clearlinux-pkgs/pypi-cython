...
Source0  : https://files.pythonhosted.org/packages/dc/f6/e8e302f9942cbebede88b1a0c33d0be3a738c3ac37abae87254d58ffc51c/Cython-0.29.33.tar.gz
...
%prep
%setup -q -n Cython-0.29.33
cd %{_builddir}/Cython-0.29.33
pushd ..
cp -a Cython-0.29.33 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673017836

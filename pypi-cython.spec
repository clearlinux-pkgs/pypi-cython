...
Source0  : https://files.pythonhosted.org/packages/cf/f7/db37a613aec5abcd51c8000a386a701ac32e94659aa03fa69c3e5c19b149/cython-3.1.0.tar.gz
...
%prep
%setup -q -n cython-3.1.0
cd %{_builddir}/cython-3.1.0
pushd ..
cp -a cython-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746800899

...
Source0  : https://files.pythonhosted.org/packages/70/fa/f1c0a37b5d37378cd37eaa16341b65f98df13bc53042e0081a31bd63c929/Cython-0.29.29.tar.gz
...
%prep
%setup -q -n Cython-0.29.29
cd %{_builddir}/Cython-0.29.29
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652735883
...
cp %{_builddir}/Cython-0.29.29/COPYING.txt %{buildroot}/usr/share/package-licenses/pypi-cython/38099d4531dd3d32b72df546041f15201123547f
cp %{_builddir}/Cython-0.29.29/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-cython/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33

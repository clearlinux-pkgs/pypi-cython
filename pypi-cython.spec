...
Source0  : https://files.pythonhosted.org/packages/18/40/7b17cd866158238db704965da1b5849af261dbad393ea3ac966f934b2d39/cython-3.1.2.tar.gz
...
%prep
%setup -q -n cython-3.1.2
cd %{_builddir}/cython-3.1.2
pushd ..
cp -a cython-3.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749565761

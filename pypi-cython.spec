...
Source0  : https://files.pythonhosted.org/packages/16/fb/82178bc16887eb9b03f2fc73c50aaa96ce528c3fd3c6f89cae631923af15/Cython-3.0.5.tar.gz
...
%prep
%setup -q -n Cython-3.0.5
cd %{_builddir}/Cython-3.0.5
pushd ..
cp -a Cython-3.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698764878

...
Source0  : https://files.pythonhosted.org/packages/68/09/ffb61f29b8e3d207c444032b21328327d753e274ea081bc74e009827cc81/Cython-3.0.8.tar.gz
...
%prep
%setup -q -n Cython-3.0.8
cd %{_builddir}/Cython-3.0.8
pushd ..
cp -a Cython-3.0.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704901678
